...
granularity_time_increment_map = {
    ...
    Granularity.FIVE_MINUTES: timedelta(hours=24),
...
granularity_default_time_period = {
    ...
    Granularity.FIVE_MINUTES: timedelta(days=5),
...
def scrape_candlestick_data():
    try:
        ...
        exit(0)
    except ServerSelectionTimeoutError as mongo_server_error:
        print(f"Cannot connect to a mongodb instance: {mongo_server_error}")
        exit(1)
